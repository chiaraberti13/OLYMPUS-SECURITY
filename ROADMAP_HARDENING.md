...
| **Apollo** (detection) | ~~normalizzazione **ECS**~~ (fatto: `olympus.apollo.ecs`, export NDJSON per SIEM); ancora aperti: import regole **Sigma** (richiede parser YAML, dipendenza non dichiarata), **OCSF**, connettori SIEM push | `P1` |
