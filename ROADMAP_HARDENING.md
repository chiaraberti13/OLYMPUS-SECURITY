...
| **Apollo** (detection) | ~~normalizzazione **ECS/OCSF**~~ (fatti: `olympus.apollo.ecs`/`.ocsf`, export NDJSON per SIEM), ~~mappatura **ATT&CK**~~ (layer Navigator via `apollo attack-layer`); ancora aperti: import regole **Sigma**, connettori SIEM push (rete) | `P1` |
