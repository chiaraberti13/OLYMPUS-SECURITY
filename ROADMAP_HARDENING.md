...
| **Metis** (CTI) | ~~**STIX 2.1** export/import~~ (fatto: `olympus.metis.stix`, round-trip deterministico, sottoinsieme fedele con skip espliciti); ancora aperti: TAXII, **MISP**, backup/restore, cifratura campi sensibili | `P1` |
